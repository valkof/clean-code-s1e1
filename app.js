...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="input item__input-checkbox";
    editInput.type="text";
    editInput.className="input item__input-text";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button item__button-edit";

    deleteButton.className="button item__button-del";
...
//select ListItems children
    ...
    var deleteButton=taskListItem.querySelector("button.item__button-del");
